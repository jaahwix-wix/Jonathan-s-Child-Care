...
export const exportStudentsPdf = (students: Student[]) => {
  ...
  if (finalY + 35 < 280) {
    ...
    doc.text("Winston Davies (Director / Administration)", 110, finalY + 33);
  }
...
export const exportOrphanRosterPdf = (orphans: OrphanRecord[]) => {
  ...
  if (finalY + 30 < 280) {
    ...
    doc.text("Counter-signed: Winston Davies (Director & Administrator, JCC Ministries)", 14, finalY + 20);
...
export const exportOrphanWelfarePdf = (orphan: OrphanRecord) => {
  ...
  if (finalY + 25 < 280) {
    ...
    doc.text("Director Sign-off: Winston Davies (Director & Administrator, JCC Bo)", 14, finalY + 18);
  }
